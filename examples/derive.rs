...
use scuffle_config::{sources, Config, ConfigBuilder, ConfigError};

type TypeAlias = bool;

#[derive(scuffle_config::Config, Debug, PartialEq, serde::Deserialize, Default)]
#[serde(default)]
struct AppConfig {
	enabled: TypeAlias,
...
#[derive(scuffle_config::Config, Debug, PartialEq, serde::Deserialize)]
#[serde(default)]
